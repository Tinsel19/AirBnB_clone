...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        stt = State(id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(stt.id, "345")
        self.assertEqual(stt.created_at, dt)
        self.assertEqual(stt.updated_at, dt)
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        stt = State()
        stt.middle_name = "Holberton"
        stt.my_number = 98
        self.assertEqual("Holberton", stt.middle_name)
    ...
    def test_contrast_to_dict_dunder_dict(self):
        stt = State()
        self.assertNotEqual(stt.to_dict(), st.__dict__)
