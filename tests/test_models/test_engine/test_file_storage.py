...
class TestFileStorage_methods(unittest.TestCase):
    ...
    def test_save(self):
        ...
        models.storage.save()
        save_text = ""
        with open("file.json", mode="r") as fd:
            save_text = fd.read()
    ...
    def test_reload(self):
        ...
        obj_s = FileStorage._FileStorage__objects
        self.assertIn("BaseModel." + base_model.id, obj_s)
        self.assertIn("User." + user.id, obj_s)
        self.assertIn("State." + state.id, obj_s)
        self.assertIn("Place." + place.id, obj_s)
        self.assertIn("City." + city.id, obj_s)
        self.assertIn("Amenity." + amenity.id, obj_s)
        self.assertIn("Review." + review.id, obj_s)
