...
def err_manager(line, argc):
    ''' takes care of errors while parsing '''
    if not line:
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_quit(self, line):
        ...
        - exits the command interpreter when quit is entered
        -> Command: quit
        '''
        return True
    ...
    def emptyline(self):
        '''
            Do nothing upon receiving an empty line or string.
